...
import (
	...
	"github.com/bytom-spv/equity/compiler"
)
...
func main() {
	...
	imports := map[string]bool{
		...
		"encoding/hex": true,
		"fmt":          true,
		"github.com/bytom-spv/equity/compiler": true,
		"github.com/bytom-spv/protocol/vm":     true,
	}
...
func asGoParams(params []*compiler.Param) (goParams string, imports []string) {
	...
	for _, p := range params {
		...
		case "Asset":
			typ = "bc.AssetId"
			imports = append(imports, "github.com/bytom-spv/protocol/bc")
		case "Boolean":
			typ = "bool"
		case "Hash":
			typ = "[]byte"
		...
		case "PublicKey":
			...
			imports = append(imports, "github.com/bytom-spv/crypto/ed25519")
		case "Signature":
			typ = "[]byte"
		case "String":
			typ = "[]byte"
